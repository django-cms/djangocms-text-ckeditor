...
!function(t){window.CKEDITOR_BASEPATH=t("[data-ckeditor-basepath]").attr("data-ckeditor-basepath"),CMS.CKEditor={options:{language:"en",skin:"moono-lisa",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockqote","-","Link","Unlink","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},static_url:"/static/djangocms-text-ckeditor",ckeditor_basepath:"/static/djangocms-text-ckeditor/ckeditor/",CSS:[],editors:{},init:function(i,e,n,o){this.container=t(i),this.container.data("ckeditor-initialized",!0),this.options.toolbar=o.toolbar,this.options=t.extend(!1,{settings:o},this.options,n),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsdialog,cmsresize,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$nonEditable["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",o.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg"),"admin"===e?(this.editor=CKEDITOR.replace(i,this.options),CKEDITOR.on("instanceReady",t.proxy(CMS.CKEditor,"setupAdmin"))):(this.editor=CKEDITOR.inline(i,this.options),CKEDITOR.on("instanceReady",o.callback)),CMS.CKEditor.editors[o.plugin_id]={editor:this.editor,options:n,settings:o,container:i,changed:!1,child_changed:!1}},initInlineEditors:function(){void 0!==CMS._plugins&&CMS._plugins.forEach(function(i){if("TextPlugin"===i[1].plugin_type){var e=i[1].urls.edit_plugin,n=i[1].plugin_id,o=t(".cms-plugin.cms-plugin-"+n);if(o.length>0){var s={},r={};s=JSON.parse(document.getElementById("ck-text-config-"+n).textContent),s&&(r=s.options,delete s.options),console.log(r,s);var d=o.wrapAll("<div class='cms-ckeditor-inline-wrapper' contenteditable='true'></div>").parent();o=o.removeClass("cms-plugin").removeClass("cms-plugin-"+n),d.addClass("cms-plugin").addClass("cms-plugin-"+n),s.plugin_id=n,s.callback=function(){var i=t('style[data-cke="true"]');CMS.CKEditor.editors[n].editor.on("change",function(){CMS.CKEditor.editors[n].changed=!0}),i.length>0&&(CMS.CKEditor5.CSS=i.clone()),d.on("dblclick",function(t){t.stopPropagation()}),d.on("pointerover",function(t){t.stopPropagation()}),d.on("blur",function(){setTimeout(function(){document.activeElement.classList.contains("cke_panel_frame")||document.activeElement.classList.contains("cke_dialog_ui_button")||CMS.CKEditor.save_data(n)},0)}),d.on("focus",function(){CMS.CKEditor._highlight_Textplugin(n)})},s.url=e,CMS.CKEditor.init(d[0],"inline",r,s)}}})},save_data:function(i,e){var n=CMS.CKEditor.editors[i];if(n.changed){var o=n.editor.getData();this.storeCSSlinks(),console.log("Saving",i,CMS.config.csrf),CMS.CKEditor.editors[i].changed=!1,CMS.API.Toolbar.showLoader(),t.post(CMS.API.Helpers.updateUrlWithPath(n.settings.url),{csrfmiddlewaretoken:CMS.config.csrf,body:o,_save:"Save"},function(o){if(CMS.API.Toolbar.hideLoader(),void 0!==e&&e(n,o),CMS.CKEditor.editors[i].child_changed){var s=t(o).find("script:not([src])").addClass("cms-ckeditor-result");CMS.CKEditor._destroyAll(),s.each(function(i,e){t("body").append(e)})}}).fail(function(t){CMS.CKEditor.editors[i].changed=!0,CMS.API.Messages.open(t)})}},storeCSSlinks:function(){t("link[rel='stylesheet'][type='text/css'][href*='ckeditor']").each(function(t,i){CMS.CKEditor.CSS.includes(i.href)||CMS.CKEditor.CSS.push(i.href)})},setupAdmin:function(){var i=this,e=window.parent||window;this._isAloneInModal()&&(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-63),this.editor.execCommand("maximize"),t(window).on("resize.ckeditor",function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)}).trigger("resize.ckeditor"),e.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-63),setTimeout(function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(i){i.preventDefault();var e=new CMS.$.Event("mousedown");t.extend(e,{screenX:i.originalEvent.screenX,screenY:i.originalEvent.screenY}),t(this).trigger(e)})},_isAloneInModal:function(){return this.container.closest("body").is(".app-djangocms_text_ckeditor.model-text")},_repositionDialog:function(t){if(t){var i=t.getSize(),e=t.getPosition(),n=CKEDITOR.document.getWindow(),o=n.getViewPaneSize(),s=o.width,r=o.height;e.x<0&&(t.move(0,e.y),e.x=0),e.y<0&&(t.move(e.x,0),e.y=0),e.y+i.height>r&&t.resize(i.width,r-e.y-80),e.x+i.width>s&&t.resize(s-e.x,i.height)}},initAdminEditors:function(){window._cmsCKEditors=window._cmsCKEditors||[];var i,e,n=[];window._cmsCKEditors.forEach(function(t){i=JSON.parse(document.getElementById("ck-text-config-"+t[1]).textContent),e=i.options,delete i.options,t[0].match(/__prefix__/)?n.push(t):CMS.CKEditor.init(document.getElementById(t[0]),"admin",e,i)}),t(".add-row a").on("click",function(){t(".CMS_CKEditor").each(function(o,s){var r=t(s);if(!r.data("ckeditor-initialized")){var d=r.attr("id");n.forEach(function(t){var n=t[0].id,o=new RegExp(n.replace("__prefix__","\\d+"));d.match(o)&&CMS.CKEditor.init(document.getElementById(d),e,i)})}})})},_highlight_Textplugin:function(i){var e=t(".cms-draggable-"+i),n=t(document),o=n.data("expandmode");n.data("expandmode",!1),e.parents(".cms-draggable").find('> .cms-dragitem-collapsable:not(".cms-dragitem-expanded") > .cms-dragitem-text').each(function(i,e){t(e).triggerHandler(CMS.Plugin.click)}),e.length>0&&(setTimeout(function(){n.data("expandmode",o)}),setTimeout(function(){var t=e.offsetParent(),i=e.position().top+t.scrollTop();e.offsetParent().scrollTop(i-window.innerHeight/2+50),CMS.Plugin._highlightPluginStructure(e.find(".cms-dragitem:first"),{successTimeout:200,delay:1500,seeThrough:!0})},10))},_initAll:function(){CMS.CKEditor.initInlineEditors(),CMS.CKEditor.initAdminEditors()},_destroyAll:function(){for(var t in CMS.CKEditor.editors)CMS.CKEditor.editors.hasOwnProperty(t)&&(CMS.CKEditor.editors[t].editor.destroy(),delete CMS.CKEditor.editors[t])},_resetInlineEditors:function(){CMS.CKEditor.CSS.forEach(function(i){0===t("link[href='"+i+"']").length&&t("head").append(t("<link rel='stylesheet' type='text/css' href='"+i+"'>"))}),CMS.CKEditor._destroyAll(),CMS.CKEditor._initAll()}},setTimeout(function(){CMS.CKEditor._initAll()},0),t(window).on("cms-content-refresh",CMS.CKEditor._resetInlineEditors)}(CMS.$);
/*
