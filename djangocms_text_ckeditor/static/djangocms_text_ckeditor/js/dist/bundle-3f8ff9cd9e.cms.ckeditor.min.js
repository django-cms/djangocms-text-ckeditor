...
!function(t,i){"use strict";window.CKEDITOR_BASEPATH=t("[data-ckeditor-basepath]").attr("data-ckeditor-basepath"),i.CKEditor={options:{language:"en",skin:"moono-lisa",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockqote","-","Link","Unlink","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},static_url:"/static/djangocms-text-ckeditor",ckeditor_basepath:"/static/djangocms-text-ckeditor/ckeditor/",CSS:[],editors:{},init:function(e,o,n,r){this.container=t(e),this.container.data("ckeditor-initialized",!0),this.options.toolbar=r.toolbar,this.options=t.extend(!1,{settings:r},this.options,n),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsdialog,cmsresize,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$nonEditable["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",r.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg"),"admin"===o?(this.editor=CKEDITOR.replace(e,this.options),CKEDITOR.on("instanceReady",t.proxy(i.CKEditor,"setupAdmin"))):(this.editor=CKEDITOR.inline(e,this.options),CKEDITOR.on("instanceReady",r.callback)),i.CKEditor.editors[r.plugin_id]={editor:this.editor,options:n,settings:r,container:e,changed:!1,child_changed:!1}},initInlineEditors:function(){void 0!==i._plugins&&i._plugins.forEach(function(e){if("TextPlugin"===e[1].plugin_type){var o=e[1].urls.edit_plugin,n=e[1].plugin_id,r=t(".cms-plugin.cms-plugin-"+n);if(r.length>0){var s,d={};s=JSON.parse(document.getElementById("ck-text-config-"+n).textContent),s&&(d=s.options,delete s.options);var a=r.wrapAll("<div class='cms-ckeditor-inline-wrapper' contenteditable='true'></div>").parent();r.removeClass("cms-plugin").removeClass("cms-plugin-"+n),a.addClass("cms-plugin").addClass("cms-plugin-"+n),s.plugin_id=n,s.callback=function(){i.CKEditor.editors[n].editor.on("change",function(){i.CKEditor.editors[n].changed=!0}),a.on("dblclick",function(t){t.stopPropagation()}),a.on("pointerover",function(t){t.stopPropagation()}),a.on("blur",function(){setTimeout(function(){document.activeElement.classList.contains("cke_panel_frame")||document.activeElement.classList.contains("cke_dialog_ui_button")||i.CKEditor.save_data(n)},0)}),a.on("focus",function(){i.CKEditor._highlight_Textplugin(n)}),i.CKEditor.storeCSSlinks()},s.url=o,i.CKEditor.init(a[0],"inline",d,s)}}})},save_data:function(e,o){var n=i.CKEditor.editors[e];if(n.changed){var r=n.editor.getData();i.CKEditor.editors[e].changed=!1,i.API.Toolbar.showLoader(),t.post(i.API.Helpers.updateUrlWithPath(n.settings.url),{csrfmiddlewaretoken:i.config.csrf,body:r,_save:"Save"},function(r){if(i.API.Toolbar.hideLoader(),void 0!==o&&o(n,r),i.CKEditor.editors[e].child_changed){console.log("Child changed");var s=t(r).find("script:not([src])").addClass("cms-ckeditor-result");i.CKEditor._destroyAll(),s.each(function(i,e){t("body").append(e)})}else i.CKEditor.loadToolbar()}).fail(function(t){i.CKEditor.editors[e].changed=!0,i.API.Messages.open({message:t.message,error:!0})})}},loadToolbar:function(){i.API.StructureBoard._loadToolbar().done(function(e){i.API.Toolbar._refreshMarkup(t(e).find(".cms-toolbar"))}).fail(i.API.Helpers.reloadBrowser)},storeCSSlinks:function(){t("link[rel='stylesheet'][type='text/css'][href*='ckeditor']").each(function(t,e){i.CKEditor.CSS.includes(e.href)||i.CKEditor.CSS.push(e.href)})},setupAdmin:function(){var i=this,e=window.parent||window;this._isAloneInModal()&&(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-70),this.editor.execCommand("maximize"),t(window).on("resize.ckeditor",function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)}).trigger("resize.ckeditor"),e.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-70),setTimeout(function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(e){e.preventDefault();var o=new i.$.Event("mousedown");t.extend(o,{screenX:e.originalEvent.screenX,screenY:e.originalEvent.screenY}),t(this).trigger(o)})},_isAloneInModal:function(){return this.container.closest("body").is(".app-djangocms_text_ckeditor.model-text")},_repositionDialog:function(t){if(t){var i=t.getSize(),e=t.getPosition(),o=CKEDITOR.document.getWindow(),n=o.getViewPaneSize(),r=n.width,s=n.height;e.x<0&&(t.move(0,e.y),e.x=0),e.y<0&&(t.move(e.x,0),e.y=0),e.y+i.height>s&&t.resize(i.width,s-e.y-80),e.x+i.width>r&&t.resize(r-e.x,i.height)}},initAdminEditors:function(){window._cmsCKEditors=window._cmsCKEditors||[];var e,o,n=[];window._cmsCKEditors.forEach(function(t){console.log("Admin editor",t);var r="ck-cfg-"+(t[1]?t[1]:t[0]);e=JSON.parse(document.getElementById(r).textContent),o=e.options,delete e.options,t[0].match(/__prefix__/)?n.push(t):i.CKEditor.init(document.getElementById(t[0]),"admin",o,e)}),t(".add-row a").on("click",function(){t(".CMS_CKEditor").each(function(r,s){var d=t(s);if(!d.data("ckeditor-initialized")){var a=d.attr("id");n.forEach(function(t){var n=t[0].id,r=new RegExp(n.replace("__prefix__","\\d+"));a.match(r)&&i.CKEditor.init(document.getElementById(a),o,e)})}})})},_highlight_Textplugin:function(e){var o=t(".cms-draggable-"+e),n=t(document),r=n.data("expandmode");n.data("expandmode",!1),o.parents(".cms-draggable").find('> .cms-dragitem-collapsable:not(".cms-dragitem-expanded") > .cms-dragitem-text').each(function(e,o){t(o).triggerHandler(i.Plugin.click)}),o.length>0&&(setTimeout(function(){n.data("expandmode",r)}),setTimeout(function(){var t=o.offsetParent(),e=o.position().top+t.scrollTop();o.offsetParent().scrollTop(e-window.innerHeight/2+50),i.Plugin._highlightPluginStructure(o.find(".cms-dragitem:first"),{successTimeout:200,delay:1500,seeThrough:!0})},10))},_initAll:function(){i.CKEditor.touchdevice="ontouchstart"in window||navigator.msMaxTouchPoints,i.CKEditor.touchdevice||i.CKEditor.initInlineEditors(),i.CKEditor.initAdminEditors()},_destroyAll:function(){for(var t in i.CKEditor.editors)i.CKEditor.editors.hasOwnProperty(t)&&(i.CKEditor.editors[t].editor.destroy(),delete i.CKEditor.editors[t])},_resetInlineEditors:function(){console.log("Editor reset"),i.CKEditor.CSS.forEach(function(i){0===t("link[href='"+i+"']").length&&(console.log("Recover css",i),t("head").append(t("<link rel='stylesheet' type='text/css' href='"+i+"'>")))}),i.CKEditor._destroyAll(),i.CKEditor._initAll()}},setTimeout(function(){i.CKEditor._initAll()},0),t(window).on("cms-content-refresh",i.CKEditor._resetInlineEditors)}(window.CMS.$,window.CMS);
/*
