...
!function(t,e){"use strict";window.CKEDITOR_BASEPATH=t("[data-ckeditor-basepath]").attr("data-ckeditor-basepath"),e.CKEditor={options:{language:"en",skin:"moono-lisa",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},static_url:"/static/djangocms-text-ckeditor",CSS:[],editors:{},init:function(i,o,n,r,s){var d=t(i);d.data("ckeditor-initialized",!0),d.attr("contenteditable",!0),this.options.toolbar=r.toolbar,this.options=t.extend(!1,{settings:r},this.options,n),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsdialog,cmsresize,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$nonEditable["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",r.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg");var a;a="admin"===o?CKEDITOR.replace(d[0],this.options):CKEDITOR.inline(d[0],this.options),e.CKEditor.editors[a.id]={editor:a,options:n,settings:r,container:d,changed:!1,child_changed:!1},a.on("instanceReady",s)},initInlineEditors:function(){void 0!==e._plugins&&(e.CKEditor.observer=e.CKEditor.observer||new IntersectionObserver(function(i){i.forEach(function(i){if(i.isIntersecting){var o=t(i.target),n=o.data("cms_plugin_id"),r=o.data("cms_edit_url");e.CKEditor.startInlineEditor(n,r),e.CKEditor.observer.unobserve(i.target)}})},{root:null,threshold:.05}),e.CKEditor.observer.disconnect(),e._plugins.forEach(function(i){if("TextPlugin"===i[1].plugin_type){var o,n=i[1].urls.edit_plugin,r=i[1].plugin_id,s=t(".cms-plugin.cms-plugin-"+r);s.length>0&&(1===s.length&&"DIV"===s.prop("tagName")?o=s.addClass("cms-ckeditor-inline-wrapper"):(o=s.wrapAll('<div class="cms-ckeditor-inline-wrapper wrapped"></div>').parent(),s.removeClass("cms-plugin").removeClass("cms-plugin-"+r),o.addClass("cms-plugin").addClass("cms-plugin-"+r).addClass("cms-plugin-start").addClass("cms-plugin-end")),o.data("cms_edit_url",n),o.data("cms_plugin_id",r),o.on("dblclick.cms-ckeditor",function(t){t.stopPropagation()}),o.on("pointerover.cms-ckeditor",function(t){setTimeout(function(){e.API.Tooltip.displayToggle(!1,t.target,"",r)},0)}),e.CKEditor.observer.observe(o[0]))}}),t(window).on("beforeunload.cms-ckeditor",function(){for(var t in e.CKEditor.editors)if(e.CKEditor.editors.hasOwnProperty(t)&&e.CKEditor.editors[t].changed)return"Do you really want to leave this page?"}))},startInlineEditor:function(i,o){var n,r=JSON.parse(document.getElementById("ck-cfg-"+i).textContent),s=t(".cms-plugin.cms-plugin-"+i);r.plugin_id=i,r.url=o,n=r.options,delete r.options,e.CKEditor.init(s[0],"inline",n,r,function(t){t.editor.element.removeAttribute("title"),t.editor.on("change",function(){e.CKEditor.editors[t.editor.id].changed=!0}),s.on("blur.cms-ckeditor",function(){setTimeout(function(){document.activeElement.classList.contains("cke_panel_frame")||document.activeElement.classList.contains("cke_dialog_ui_button")||e.CKEditor.save_data(t.editor.id)},0)}),s.on("click.cms-ckeditor",function(){e.CKEditor._highlight_Textplugin(i)}),e.CKEditor.storeCSSlinks()})},save_data:function(i,o){var n=e.CKEditor.editors[i];if(n&&n.changed){e.CKEditor.storeCSSlinks();var r=n.editor.getData();e.API.Toolbar.showLoader(),t.post(e.API.Helpers.updateUrlWithPath(n.settings.url),{csrfmiddlewaretoken:e.config.csrf,body:r,_save:"Save"},function(i){if(n.changed=!1,e.API.Toolbar.hideLoader(),void 0!==o&&o(n,i),n.child_changed){var r=t(i).find("script:not([src])").addClass("cms-ckeditor-result");e.CKEditor._destroyAll(),r.each(function(e,i){t("body").append(i)})}else e.CKEditor.loadToolbar()}).fail(function(t){n.changed=!0,e.API.Messages.open({message:t.message,error:!0})})}},loadToolbar:function(){e.settings&&e.settings.version&&this._toolbar_bug_version(e.settings.version)?e.API.Helpers.reloadBrowser():e.API.StructureBoard._loadToolbar().done(function(i){e.API.Toolbar._refreshMarkup(t(i).find(".cms-toolbar"))}).fail(e.API.Helpers.reloadBrowser)},_toolbar_bug_version:function(t){var e=t.split(".");return"3"===e[0]&&e[1].length<2},storeCSSlinks:function(){t("link[rel='stylesheet'][type='text/css'][href*='ckeditor']").each(function(t,i){e.CKEditor.CSS.includes(i.href)||e.CKEditor.CSS.push(i.href)})},setupAdmin:function(i){var o=this,n=window.parent||window;this._isAloneInModal(e.CKEditor.editors[i.id].container)&&(i.resize("100%",n.CMS.$(".cms-modal-frame").height()-70),i.execCommand("maximize"),t(window).on("resize.ckeditor",function(){o._repositionDialog(CKEDITOR.dialog.getCurrent(),n)}).trigger("resize.ckeditor"),n.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(i.resize("100%",n.CMS.$(".cms-modal-frame").height()-70),setTimeout(function(){o._repositionDialog(CKEDITOR.dialog.getCurrent(),n)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(i){i.preventDefault();var o=new e.$.Event("mousedown");t.extend(o,{screenX:i.originalEvent.screenX,screenY:i.originalEvent.screenY}),t(this).trigger(o)})},_isAloneInModal:function(t){return t.closest("body").is(".app-djangocms_text_ckeditor.model-text")},_repositionDialog:function(t){if(t){var e=t.getSize(),i=t.getPosition(),o=CKEDITOR.document.getWindow(),n=o.getViewPaneSize(),r=n.width,s=n.height;i.x<0&&(t.move(0,i.y),i.x=0),i.y<0&&(t.move(i.x,0),i.y=0),i.y+e.height>s&&t.resize(e.width,s-i.y-80),i.x+e.width>r&&t.resize(r-i.x,e.height)}},initAdminEditors:function(){window._cmsCKEditors=window._cmsCKEditors||[];var i,o,n=[];window._cmsCKEditors.forEach(function(t){var r="ck-cfg-"+(t[1]?t[1]:t[0]);i=JSON.parse(document.getElementById(r).textContent),o=i.options,delete i.options,t[0].match(/__prefix__/)?n.push(t):e.CKEditor.init(document.getElementById(t[0]),"admin",o,i,function(t){return e.CKEditor.setupAdmin(t.editor)})}),t(".add-row a").on("click",function(){t(".CMS_CKEditor").each(function(r,s){var d=t(s);if(!d.data("ckeditor-initialized")){var a=d.attr("id");n.forEach(function(t){var n=t[0].id,r=new RegExp(n.replace("__prefix__","\\d+"));a.match(r)&&e.CKEditor.init(document.getElementById(a),o,i)})}})})},_highlight_Textplugin:function(i){var o=t(".cms-draggable-"+i),n=t(document),r=n.data("expandmode");n.data("expandmode",!1),o.parents(".cms-draggable").find('> .cms-dragitem-collapsable:not(".cms-dragitem-expanded") > .cms-dragitem-text').each(function(i,o){t(o).triggerHandler(e.Plugin.click)}),o.length>0&&(setTimeout(function(){n.data("expandmode",r)}),setTimeout(function(){e.Plugin._highlightPluginStructure(o.find(".cms-dragitem:first"),{successTimeout:200,delay:2e3,seeThrough:!0})},10))},_initAll:function(){e.CKEditor.touchdevice="ontouchstart"in window||navigator.msMaxTouchPoints,e.CKEditor.touchdevice?t("div.cms a.cms-btn.cms-edit-toggle").hide():(e.CKEditor.initInlineEditors(),t("div.cms a.cms-btn.cms-edit-toggle").show()),e.CKEditor.initAdminEditors()},_destroyAll:function(){for(var i in e.CKEditor.editors)e.CKEditor.editors.hasOwnProperty(i)&&(e.CKEditor.editors[i].editor.destroy(),t(e.CKEditor.editors[i].container).off(".cms-ckeditor"),delete e.CKEditor.editors[i]);t(window).off(".cms-ckeditor")},_resetInlineEditors:function(){e.CKEditor.CSS.forEach(function(e){0===t("link[href='"+e+"']").length&&t("head").append(t("<link rel='stylesheet' type='text/css' href='"+e+"'>"))}),e.CKEditor._destroyAll(),e.CKEditor._initAll()}},setTimeout(function(){e.CKEditor._initAll()},0),t(window).on("cms-content-refresh",e.CKEditor._resetInlineEditors)}(window.CMS.$,window.CMS);
/*
...
a&&this.stack.splice(a,1)},resetInputs:function(a){if("number"==typeof a)this.getLast(a).inputs=0;else for(a=this.stack.length;a--;)this.stack[a].inputs=0},getTotalInputs:function(){for(var a=this.stack.length,b=0;a--;)b+=this.stack[a].inputs;return b},cleanUp:function(a){a=a.data.$;a.ctrlKey||a.metaKey||this.remove(17);a.shiftKey||this.remove(16);a.altKey||this.remove(18)}}})();CKEDITOR.plugins.add("flash",{init:function(){CKEDITOR.error("editor-plugin-deprecated",{plugin:"flash"})}});CKEDITOR.tools.extend(CKEDITOR.config,{flashEmbedTagOnly:!1,flashAddEmbedTag:!0,flashConvertOnEdit:!1});(function(){function m(a,d){CKEDITOR.tools.extend(this,{editor:a,editable:a.editable(),doc:a.document,win:a.window},d,!0);this.inline=this.editable.isInline();this.inline||(this.frame=this.win.getFrame());this.target=this[this.inline?"editable":"doc"]}function n(a,d){CKEDITOR.tools.extend(this,d,{editor:a},!0)}function p(a,d){var b=a.editable();CKEDITOR.tools.extend(this,{editor:a,editable:b,inline:b.isInline(),doc:a.document,win:a.window,container:CKEDITOR.document.getBody(),winTop:CKEDITOR.document.getWindow()},
...
!function(e){function t(e){var t=(e.match(/<\s*([^>\s]+)[\s\S]*?>/)||[0,!1]).splice(1),n=t.some(function(e){return e&&CKEDITOR.dtd.$block[e]}),i="span";return n&&(i="div"),i}function n(t,n){t.each(function(t,i){var l,a=e(i);l=e("<"+n+">"),e.each(i.attributes,function(e,t){l.attr(t.nodeName,t.nodeValue)}),l.html(a.html()),a.replaceWith(l)})}CKEDITOR&&CKEDITOR.plugins&&CKEDITOR.plugins.registered&&CKEDITOR.plugins.registered.cmsplugins||CKEDITOR.plugins.add("cmsplugins",{icons:"cmsplugins",init:function(t){var n=this;CKEDITOR.on("instanceReady",function(){var e=[];for(var i in t.widgets.instances)t.widgets.instances.hasOwnProperty(i)&&e.push(t.widgets.instances[i]);n.numberOfChildren=CKEDITOR.tools.array.filter(e,function(e){return"cms-widget"===e.name}).length}),this.unsaved_child_plugins=[];var i=CMS.CKEditor.editors[t.id].settings;if(this.setupCancelCleanupCallback(i),void 0===i||void 0===i.plugins)return!1;this.setupDialog(t),t.ui.add("cmsplugins",CKEDITOR.UI_PANELBUTTON,{toolbar:"cms,0",label:i.lang.toolbar,title:i.lang.toolbar,className:"cke_panelbutton__cmsplugins",modes:{wysiwyg:1},editorFocus:0,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(t.config.contentsCss),attributes:{role:"cmsplugins","aria-label":i.lang.aria}},onBlock:function(i,l){l.element.setHtml(t.plugins.cmsplugins.setupDropdown(t)),e(l.element.$).find(".cke_panel_listItem a").bind("click",function(l){l.preventDefault(),n.addPlugin(e(this),i,t)})}}),t.contextMenu&&this.setupContextMenu(t),t.addCommand("cmspluginsEdit",{exec:function(){var e=n.getElementFromSelection(t),i=n.getPluginWidget(e);i&&n.editPlugin(i,t)}});var l=function(n){if("touchend"===n.type||"click"===n.type){var i,l=e(n.currentTarget).closest("cms-plugin")[0];i=new CKEDITOR.dom.element(l).getParent(),n.data=n.data||{},t.getSelection().fake(i)}t.execCommand("cmspluginsEdit")};t.on("doubleclick",l),t.on("instanceReady",function(){}),this.setupDataProcessor(t)},getElementFromSelection:function(e){var t=e.getSelection();return t.getSelectedElement()||t.getCommonAncestor().getAscendant("cms-plugin",!0)},getPluginWidget:function(e){return e?e.getAscendant("cms-plugin",!0)||e.findOne("cms-plugin"):null},setupDialog:function(t){var n=this,i=function(){return{title:"",minWidth:200,minHeight:200,contents:[{elements:[{type:"html",html:'<iframe style="position:static; width:100%; height:100%; border:none;" />'}]}],onOk:function(i){var l=e(CKEDITOR.dialog.getCurrent().parts.contents.$).find("iframe").contents(),a=l[0].URL;l.find("form").submit();var s=CMS.API.Helpers.onPluginSave;return CMS.API.Helpers.onPluginSave=function(){CKEDITOR.dialog.getCurrent().hide();var e=CMS.API.Helpers.dataBridge,l=!1;return a.match(/add-plugin/)&&(l=!0),!t.config.settings.delete_on_cancel&&l&&n.unsaved_child_plugins.push(e.plugin_id),n.insertPlugin(e,i.sender._.editor),n.numberOfChildren+=1,CMS.API.Helpers.onPluginSave=s,!1},!1}}};CKEDITOR.dialog.add("cmspluginsDialog",i)},setupDropdown:function(t){var n='<div class="cke_panel_block">';return e.each(t.config.settings.plugins,function(t,i){n+='<h1 class="cke_panel_grouptitle">'+i.group+"</h1>",n+='<ul role="presentation" class="cke_panel_list">',e.each(i.items,function(e,t){n+='<li class="cke_panel_listItem"><a href="#" rel="'+t.type+'">'+t.title+"</a></li>"}),n+="</ul>"}),n+="</div>"},setupContextMenu:function(e){var t=this;e.addMenuGroup("cmspluginsGroup"),e.addMenuItem("cmspluginsItem",{label:e.config.settings.lang.edit,icon:e.config.settings.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg",command:"cmspluginsEdit",group:"cmspluginsGroup"}),e.removeMenuItem("image"),e.contextMenu.addListener(function(e){if(t.getPluginWidget(e))return{cmspluginsItem:CKEDITOR.TRISTATE_OFF}})},editPlugin:function(t,n){var i=t.getAttribute("id"),l=CMS.CKEditor.editors[n.id].settings;n.openDialog("cmspluginsDialog");var a=CMS.$(window),s=CKEDITOR.dialog.getCurrent();s.resize(.8*a.width(),.6*a.height()),e(s.getElement().$).addClass("cms-ckeditor-dialog"),e(s.parts.title.$).text(l.lang.edit);var r=l.url||window.location.href,d=encodeURIComponent(window.parent.location.pathname+window.parent.location.search),o=r.replace(/(add-plugin|edit-plugin).*$/,"edit-plugin/"+i+"/?_popup=1&no_preview&cms_history=0&cms_path="+d);e(s.parts.contents.$).find("iframe").attr("src",o).bind("load",function(){var t=e(this).contents();t.find("body").addClass("ckeditor-popup"),t.find(".submit-row").hide(),t.find("#container").css({"min-width":0,padding:0})})},addPlugin:function(e,t,n){var i=CMS.CKEditor.editors[n.id].settings;t.hide(),n.focus(),n.fire("saveSnapshot");var l={placeholder_id:i.placeholder_id,plugin_type:e.attr("rel"),plugin_parent:i.plugin_id,plugin_language:i.plugin_language,plugin_position:i.plugin_position+1+this.numberOfChildren,cms_path:window.parent.location.pathname,cms_history:0};this.addPluginDialog(e,l,n)},addPluginDialog:function(t,n,i){var l=e(window),a=CMS.CKEditor.editors[i.id].settings,s=i.getSelection().getSelectedText();i.openDialog("cmspluginsDialog");var r=CKEDITOR.dialog.getCurrent();r.resize(.8*l.width(),.6*l.height()),e(r.getElement().$).addClass("cms-ckeditor-dialog"),e(r.parts.title.$).text(a.lang.add),e(r.parts.contents.$).find("iframe").attr("src",a.add_plugin_url+"?"+e.param(n)).on("load.addplugin",function(){var t=e(this),n=t.contents();n.find(".submit-row").hide().end().find("#container").css("min-width",0).css("padding",0);var i=n.find(".js-ckeditor-use-selected-text");i.length||(i=n.find("#id_name")),i.val()&&i.val().trim()||i.val(s),t.off("load.addplugin")})},insertPlugin:function(t,n){var i=CMS.CKEditor.editors[n.id].settings;e.ajax({method:"GET",url:i.render_plugin_url,data:{token:i.action_token,plugin:t.plugin_id}}).done(function(e,t,i){CMS.CKEditor.editors[n.id].changed=!0,CMS.CKEditor.editors[n.id].child_changed=!0,200===i.status?n.insertHtml(e,"unfiltered_html"):204===i.status&&n.insertHtml(n.getSelectedHtml().$.textContent),n.fire("updateSnapshot")})},setupCancelCleanupCallback:function(t){if(window.parent&&window.parent.CMS&&window.parent.CMS.API&&window.parent.CMS.API.Helpers){var n=this,i=window.parent.CMS,l=function(l,a){if((t.delete_on_cancel||n.unsaved_child_plugins.length)&&n.unsaved_child_plugins.length){l.preventDefault(),i.API.Toolbar.showLoader();var s={token:t.action_token};t.delete_on_cancel||(s.child_plugins=n.unsaved_child_plugins),e.ajax({method:"POST",url:t.cancel_plugin_url,data:s,traditional:!0}).done(function(){i.API.Helpers.removeEventListener("modal-close.text-plugin.text-plugin-"+t.plugin_id),a.instance.close()}).fail(function(e){i.API.Messages.open({message:e.responseText+" | "+e.status+" "+e.statusText,delay:0,error:!0})})}};i.API.Helpers.addEventListener("modal-close.text-plugin.text-plugin-"+t.plugin_id,l)}},setupDataProcessor:function(i){function l(e){return e.attributes&&"div"===e.attributes["data-cke-real-element-type"]}CKEDITOR.htmlParser.element=CKEDITOR.tools.override(CKEDITOR.htmlParser.element,function(e){return function(t,n){e.call(this,t,n),"cms-plugin"===t&&"span"===n["data-cke-real-element-type"]&&(this._.isBlockLike=!1)}}),i.dataProcessor.dataFilter.addRules({elements:{span:function(t){if(CKEDITOR.plugins.widget.isParserWidgetWrapper(t)){var n=t.getFirst();if(l(n)){var a=new CKEDITOR.htmlParser.element("div",e.extend({},t.attributes));return i.widgets.registered.cmswidget.inline=!1,a.children=t.children,a.removeClass("cke_widget_inline"),a.removeClass("cke_widget_force_block"),a.addClass("cke_widget_block"),n.attributes["data-cke-real-element-type"]="div",a}i.widgets.registered.cmswidget.inline=!0,n.attributes["data-cke-real-element-type"]="span"}return t}}},{priority:1,applyToAll:!0}),i.on("toHtml",function(i){var l=i.data.dataValue.replace(/<cms-plugin(.*?)>([\s\S]*?)<\/cms-plugin>/gi,function(e,n,i){var l=t(i);return n.match(/render-plugin=["']?false/gi)?'<cms-plugin data-cke-real-element-type="'+l+'" '+n+"><"+l+' class="cms-ckeditor-plugin-label">'+n.replace(/[\s\S]*alt=["']([\s\S]*?)['"][\s\S]*/,"$1")+"</"+l+"></cms-plugin>":'<cms-plugin data-cke-real-element-type="'+l+'" '+n+">"+i+"</cms-plugin>"});if(l.match(/<cms-plugin[^>]*(?=data-cke-real-element-type=\"div)/)){var a=/<cms-plugin([^>]*(?=data-cke-real-element-type=\"div)[\s\S]*?>[\s\S]*?<\/)cms-plugin>/g,s=l.replace(a,"<div$1div>"),r=e(s).wrapAll("<div>").parent();n(r.find('div[data-cke-real-element-type="div"]'),"cms-plugin"),l=r.html()}i.data.dataValue=l},null,null,4),i.on("toHtml",function(){i.widgets&&i.widgets.registered&&i.widgets.registered.cmswidget&&(i.widgets.registered.cmswidget.inline=!0)},null,null,1)}})}(CMS.$);
});
})(CMS.$);
