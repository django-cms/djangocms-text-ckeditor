 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
CKEDITOR.plugins.add("cmsresize",{init:function(e){function i(i){var t=i.originalEvent.screenX-s.x,r=i.originalEvent.screenY-s.y,a=d.width,c=d.height,l=a+t*("rtl"==o?-1:1),z=c+r;m&&(a=Math.max(n.resize_minWidth,Math.min(l,n.resize_maxWidth))),h&&(c=Math.max(n.resize_minHeight,Math.min(z,n.resize_maxHeight))),e.resize(m?a:null,c)}function t(){CMS.$(CKEDITOR.document.$).off("pointermove",i),CMS.$(CKEDITOR.document.$).off("pointerup",t),e.document&&(CMS.$(e.document.$).off("pointermove",i),CMS.$(e.document.$).off("pointerup",t))}var n=e.config,r=e.ui.spaceId("resizer"),o=e.element?e.element.getDirection(1):"ltr";if(!n.resize_dir&&(n.resize_dir="vertical"),void 0===n.resize_maxWidth&&(n.resize_maxWidth=3e3),void 0===n.resize_maxHeight&&(n.resize_maxHeight=3e3),void 0===n.resize_minWidth&&(n.resize_minWidth=750),void 0===n.resize_minHeight&&(n.resize_minHeight=250),n.resize_enabled!==!1){var s,d,a=null,m=("both"==n.resize_dir||"horizontal"==n.resize_dir)&&n.resize_minWidth!=n.resize_maxWidth,h=("both"==n.resize_dir||"vertical"==n.resize_dir)&&n.resize_minHeight!=n.resize_maxHeight,c=CKEDITOR.tools.addFunction(function(r){a||(a=e.getResizable()),d={width:a.$.offsetWidth||0,height:a.$.offsetHeight||0},s={x:r.screenX,y:r.screenY},n.resize_minWidth>d.width&&(n.resize_minWidth=d.width),n.resize_minHeight>d.height&&(n.resize_minHeight=d.height),CMS.$(CKEDITOR.document.$).on("pointermove",i),CMS.$(CKEDITOR.document.$).on("pointerup",t),e.document&&(CMS.$(e.document.$).on("pointermove",i),CMS.$(e.document.$).on("pointerup",t)),r.preventDefault&&r.preventDefault()});CMS.$(CKEDITOR.document.$).find("html").attr("data-touch-action","none"),e.on("destroy",function(){CKEDITOR.tools.removeFunction(c)}),e.on("uiSpace",function(i){if("bottom"==i.data.space){var t="";m&&!h&&(t=" cke_resizer_horizontal"),!m&&h&&(t=" cke_resizer_vertical");var n='<span id="'+r+'" class="cms-ckeditor-resizer cke_resizer'+t+" cke_resizer_"+o+'" title="'+CKEDITOR.tools.htmlEncode(e.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+c+', event)">'+("ltr"==o?"◢":"◣")+"</span>";"ltr"==o&&"ltr"==t?i.data.html+=n:i.data.html=n+i.data.html}},e,null,100),e.on("maximize",function(i){e.ui.space("resizer")[i.data==CKEDITOR.TRISTATE_ON?"hide":"show"]()})}}})}(CMS.$);
!function(t){function e(t){var e=(t.match(/<([\S]*?)\s[\s\S]*?>/)||[0,!1]).splice(1),i=e.some(function(t){return t&&CKEDITOR.dtd.$block[t]}),n="span";return i&&(n="div"),n}function i(e,i){e.each(function(e,n){var s,o=t(n);s=t("<"+i+">"),t.each(n.attributes,function(t,e){s.attr(e.nodeName,e.nodeValue)}),s.html(o.html()),o.replaceWith(s)})}CKEDITOR&&CKEDITOR.plugins&&CKEDITOR.plugins.registered&&CKEDITOR.plugins.registered.cmsplugins||CKEDITOR.plugins.add("cmsplugins",{icons:"cmsplugins",init:function(e){var i=this;if(this.options=CMS.CKEditor.options.settings,this.editor=e,this.child_plugins=[],this.setupCancelCleanupCallback(this.options),void 0===this.options||void 0===this.options.plugins)return!1;this.setupDialog(),this.options.plugins_integration&&"buttons"===this.options.plugins_integration?this._initButtons():this._initDropdown(),this.editor.contextMenu&&this.setupContextMenu(),this.editor.addCommand("cmspluginsEdit",{exec:function(){var t=i.getElementFromSelection(),e=i.getPluginWidget(t);e&&i.editPlugin(e)}});var n=function(e){var n;if("touchend"===e.type||"click"===e.type){var s=t(e.currentTarget).closest("cms-plugin")[0];n=new CKEDITOR.dom.element(s).getParent(),e.data=e.data||{},i.editor.getSelection().fake(n)}i.editor.execCommand("cmspluginsEdit")};this.editor.on("doubleclick",n),this.editor.on("instanceReady",function(){CMS.$("cms-plugin",CMS.$("iframe.cke_wysiwyg_frame")[0].contentWindow.document.documentElement).on("click touchend",n)}),this.setupDataProcessor()},_initDropdown:function(){var e=this;this.editor.ui.add("cmsplugins",CKEDITOR.UI_PANELBUTTON,{toolbar:"cms,0",label:this.options.lang.toolbar,title:this.options.lang.toolbar,className:"cke_panelbutton__cmsplugins",modes:{wysiwyg:1},editorFocus:0,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(e.editor.config.contentsCss),attributes:{role:"cmsplugins","aria-label":this.options.lang.aria}},onBlock:function(i,n){n.element.setHtml(e.editor.plugins.cmsplugins.setupDropdown());var s=t(n.element.$).find(".cke_panel_listItem a");s.bind("click",function(n){n.preventDefault(),e.addPlugin(t(this).rel,i)})}})},_getPluginIconPath:function(t){return t.icon_path?t.icon_path:CMS.CKEditor.options.settings.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.png"},_initButtons:function(){var e=this,i=null;t.each(this.options.plugins,function(n,s){t.each(s.items,function(t,n){i={command:"cmsPlugin"+n.type,label:n.title,icon:CKEDITOR.getUrl(e._getPluginIconPath(n)),toolbar:"cms"},e.editor.addCommand(i.command,{exec:function(){e.addPlugin(n.type)}}),e.editor.ui.addButton(i.command,i)})})},getElementFromSelection:function(){var t=this.editor.getSelection(),e=t.getSelectedElement()||t.getCommonAncestor().getAscendant("cms-plugin",!0);return e},getPluginWidget:function(t){return t?t.getAscendant("cms-plugin",!0)||t.findOne("cms-plugin"):null},setupDialog:function(){var e=this,i=function(){return{title:"",minWidth:200,minHeight:200,contents:[{elements:[{type:"html",html:'<iframe style="position:static; width:100%; height:100%; border:none;" />'}]}],onOk:function(){var i=t(CKEDITOR.dialog.getCurrent().parts.contents.$).find("iframe").contents();i.find("form").submit();var n=CMS.API.Helpers.reloadBrowser;return CMS.API.Helpers.reloadBrowser=function(){return CKEDITOR.dialog.getCurrent().hide(),e.insertPlugin(CMS.API.Helpers.dataBridge),CMS.API.Helpers.reloadBrowser=n,!1},!1}}};CKEDITOR.dialog.add("cmspluginsDialog",i)},setupDropdown:function(){var e='<div class="cke_panel_block">';return t.each(this.options.plugins,function(i,n){e+='<h1 class="cke_panel_grouptitle">'+n.group+"</h1>",e+='<ul role="presentation" class="cke_panel_list">',t.each(n.items,function(t,i){e+='<li class="cke_panel_listItem"><a href="#" rel="'+i.type+'">'+i.title+"</a></li>"}),e+="</ul>"}),e+="</div>"},setupContextMenu:function(){var t=this;this.editor.addMenuGroup("cmspluginsGroup"),this.editor.addMenuItem("cmspluginsItem",{label:this.options.lang.edit,icon:CMS.CKEditor.options.settings.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.png",command:"cmspluginsEdit",group:"cmspluginsGroup"}),this.editor.removeMenuItem("image"),this.editor.contextMenu.addListener(function(e){var i=t.getPluginWidget(e);if(i)return{cmspluginsItem:CKEDITOR.TRISTATE_OFF}})},editPlugin:function(e){var i=e.getAttribute("id");this.editor.openDialog("cmspluginsDialog");var n=CMS.$(document),s=CKEDITOR.dialog.getCurrent();s.resize(.8*n.width(),.7*n.height()),t(s.getElement().$).addClass("cms-ckeditor-dialog"),t(s.parts.title.$).text(this.options.lang.edit);var o=window.location.href,l=o.replace(/(add-plugin|edit-plugin).*$/,"edit-plugin/"+i+"/?_popup=1&no_preview");t(s.parts.contents.$).find("iframe").attr("src",l).bind("load",function(){var e=t(this).contents();e.find("body").addClass("ckeditor-popup"),e.find(".submit-row").hide(),e.find("#container").css({"min-width":0,padding:0})})},addPlugin:function(t,e){var i=this;e&&e.hide(),this.editor.focus(),this.editor.fire("saveSnapshot");var n={placeholder_id:this.options.placeholder_id,plugin_type:t,plugin_parent:this.options.plugin_id,plugin_language:this.options.plugin_language};i.addPluginDialog(n)},addPluginDialog:function(e){var i=t(document),n=this.editor.getSelection().getSelectedText();this.editor.openDialog("cmspluginsDialog");var s=CKEDITOR.dialog.getCurrent();s.resize(.8*i.width(),.7*i.height()),t(s.getElement().$).addClass("cms-ckeditor-dialog"),t(s.parts.title.$).text(this.options.lang.add),t(s.parts.contents.$).find("iframe").attr("src",this.options.add_plugin_url+"?"+t.param(e)).on("load.addplugin",function(){var e=t(this),i=e.contents();i.find(".submit-row").hide().end().find("#container").css("min-width",0).css("padding",0);var s=i.find(".js-ckeditor-use-selected-text");s.length||(s=i.find("#id_name")),s.val()&&s.val().trim()||s.val(n),e.off("load.addplugin")})},insertPlugin:function(e){var i=this;t.ajax({method:"GET",url:i.options.render_plugin_url,data:{token:i.options.action_token,plugin:e.plugin_id}}).done(function(t){i.options.delete_on_cancel||i.child_plugins.push(e.plugin_id),i.editor.insertHtml(t,"unfiltered_html"),i.editor.fire("updateSnapshot")})},setupCancelCleanupCallback:function(){if(window.parent&&window.parent.CMS&&window.parent.CMS.API&&window.parent.CMS.API.Helpers){var e=this,i=window.parent.CMS,n=function(n,s){if(e.options.delete_on_cancel||e.child_plugins.length){n.preventDefault(),i.API.Toolbar.showLoader();var o={token:e.options.action_token};e.options.delete_on_cancel||(o.child_plugins=e.child_plugins),t.ajax({method:"POST",url:e.options.cancel_plugin_url,data:o,traditional:!0}).done(function(){i.API.Helpers.removeEventListener("modal-close.text-plugin-"+e.options.plugin_id),s.instance.close()}).fail(function(t){i.API.Messages.open({message:t.responseText+" | "+t.status+" "+t.statusText,delay:0,error:!0})})}};i.API.Helpers.addEventListener("modal-close.text-plugin-"+e.options.plugin_id,n)}},setupDataProcessor:function(){function n(t){return t.attributes&&"div"===t.attributes["data-cke-real-element-type"]}var s=this,o=1,l=4;CKEDITOR.htmlParser.element=CKEDITOR.tools.override(CKEDITOR.htmlParser.element,function(t){return function(e,i){t.call(this,e,i),"cms-plugin"===e&&"span"===i["data-cke-real-element-type"]&&(this._.isBlockLike=!1)}}),this.editor.dataProcessor.dataFilter.addRules({elements:{span:function(e){if(CKEDITOR.plugins.widget.isParserWidgetWrapper(e)){var i=e.getFirst();if(n(i)){var o=new CKEDITOR.htmlParser.element("div",t.extend({},e.attributes));return s.editor.widgets.registered.cmswidget.inline=!1,o.children=e.children,o.removeClass("cke_widget_inline"),o.removeClass("cke_widget_force_block"),o.addClass("cke_widget_block"),i.attributes["data-cke-real-element-type"]="div",o}s.editor.widgets.registered.cmswidget.inline=!0,i.attributes["data-cke-real-element-type"]="span"}return e}}},{priority:1,applyToAll:!0}),this.editor.on("toHtml",function(n){var s=n.data.dataValue.replace(/<cms-plugin(.*?)>([\s\S]*?)<\/cms-plugin>/gi,function(t,i,n){var s=e(n);return i.match(/render-plugin=["']?false/gi)?'<cms-plugin data-cke-real-element-type="'+s+'" '+i+"><"+s+' class="cms-ckeditor-plugin-label">'+i.replace(/[\s\S]*alt=["']([\s\S]*?)['"][\s\S]*/,"$1")+"</"+s+"></cms-plugin>":'<cms-plugin data-cke-real-element-type="'+s+'" '+i+">"+n+"</cms-plugin>"});if(s.match(/<cms-plugin[^>]*(?=data-cke-real-element-type=\"div)/)){var o=/<cms-plugin([^>]*(?=data-cke-real-element-type=\"div).*?>.*?<\/)cms-plugin>/g,l=s.replace(o,"<div$1div>"),a=t(l).wrapAll("<div>").parent(),r=a.find('div[data-cke-real-element-type="div"]');i(r,"cms-plugin"),s=a.html()}n.data.dataValue=s},null,null,l),this.editor.on("toHtml",function(){s.editor.widgets&&s.editor.widgets.registered&&s.editor.widgets.registered.cmswidget&&(s.editor.widgets.registered.cmswidget.inline=!0)},null,null,o)}})}(CMS.$);
!function(t){t(function(){CMS.CKEditor={options:{language:"en",skin:"moono",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Maximize",""],"/",["Bold","Italic","Underline","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList","-","Outdent","Indent","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Maximize",""],"/",["Bold","Italic","Underline","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList","-","Outdent","Indent","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},init:function(i,e,n){t("#"+i).length>0&&(this.container=t("#"+i),this.options.toolbar=n.toolbar,this.options=t.extend(!1,{settings:n},this.options,e),n.plugins_integration&&"buttons"===n.plugins_integration&&this._initPluginButtons(),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsresize,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$nonEditable["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",n.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.png"),this.editor=CKEDITOR.replace(i,this.options),CKEDITOR.on("instanceReady",t.proxy(CMS.CKEditor,"setup")))},_initPluginButtons:function(){var i=[];t.each(this.options.settings.plugins,function(e,n){t.each(n.items,function(t,e){i.push("cmsPlugin"+e.type)})}),this._insertPluginButtons(this.options.toolbar_CMS,i)},_insertPluginButtons:function(t,i){for(var e=0;e<t.length;e++)if("string"==typeof t[e]){if("cmsplugins"===t[e]){t.splice(e,1);for(var n=0;n<i.length;n++)t.splice(n,0,i[i.length-n-1]);break}}else this._insertPluginButtons(t[e],i)},setup:function(){var i=this,e=window.parent||window,n=70;this._isAloneInModal()&&(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-n),this.editor.execCommand("maximize"),t(window).on("resize.ckeditor",function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)}).trigger("resize.ckeditor"),e.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(i.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-n),setTimeout(function(){i._repositionDialog(CKEDITOR.dialog.getCurrent(),e)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(i){i.preventDefault();var e=new CMS.$.Event("mousedown");t.extend(e,{screenX:i.originalEvent.screenX,screenY:i.originalEvent.screenY}),t(this).trigger(e)})},_isAloneInModal:function(){var t=this.container.closest("body");return t.is(".app-djangocms_text_ckeditor.model-text")||t.is(".djangocms_text_ckeditor-text")},_repositionDialog:function(t){var i=80;if(t){var e=t.getSize(),n=t.getPosition(),o=CKEDITOR.document.getWindow(),s=o.getViewPaneSize(),r=s.width,l=s.height;n.x<0&&(t.move(0,n.y),n.x=0),n.y<0&&(t.move(n.x,0),n.y=0),n.y+e.height>l&&t.resize(e.width,l-n.y-i),n.x+e.width>r&&t.resize(r-n.x,e.height)}}}})}(CMS.$);