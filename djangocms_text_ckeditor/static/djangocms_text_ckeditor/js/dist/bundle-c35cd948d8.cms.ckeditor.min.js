...
!function(t,i,e){"use strict";window.CKEDITOR_BASEPATH=t("[data-ckeditor-basepath]").attr("data-ckeditor-basepath"),i.CKEditor={options:{language:"en",skin:"moono-lisa",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockqote","-","Link","Unlink","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},static_url:"/static/djangocms-text-ckeditor",ckeditor_basepath:"/static/djangocms-text-ckeditor/ckeditor/",CSS:[],editors:{},init:function(n,o,s,r){this.container=t(n),this.container.data("ckeditor-initialized",!0),this.options.toolbar=r.toolbar,this.options=t.extend(!1,{settings:r},this.options,s),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsdialog,cmsresize,widget",document.createElement("cms-plugin"),e.dtd["cms-plugin"]=e.dtd.div,e.dtd.$inline["cms-plugin"]=1,e.dtd.$nonEditable["cms-plugin"]=1,e.dtd.$transparent["cms-plugin"]=1,e.dtd.body["cms-plugin"]=1,e.skin.addIcon("cmsplugins",r.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg"),"admin"===o?(this.editor=e.replace(n,this.options),e.on("instanceReady",t.proxy(i.CKEditor,"setupAdmin"))):(this.editor=e.inline(n,this.options),e.on("instanceReady",r.callback)),i.CKEditor.editors[r.plugin_id]={editor:this.editor,options:s,settings:r,container:n,changed:!1,child_changed:!1}},initInlineEditors:function(){void 0!==i._plugins&&i._plugins.forEach(function(e){if("TextPlugin"===e[1].plugin_type){var n=e[1].urls.edit_plugin,o=e[1].plugin_id,s=t(".cms-plugin.cms-plugin-"+o);if(s.length>0){var r,d={};r=JSON.parse(document.getElementById("ck-text-config-"+o).textContent),r&&(d=r.options,delete r.options);var a=s.wrapAll("<div class='cms-ckeditor-inline-wrapper' contenteditable='true'></div>").parent();s.removeClass("cms-plugin").removeClass("cms-plugin-"+o),a.addClass("cms-plugin").addClass("cms-plugin-"+o),r.plugin_id=o,r.callback=function(){i.CKEditor.editors[o].editor.on("change",function(){i.CKEditor.editors[o].changed=!0}),a.on("dblclick",function(t){t.stopPropagation()}),a.on("pointerover",function(t){t.stopPropagation()}),a.on("blur",function(){setTimeout(function(){document.activeElement.classList.contains("cke_panel_frame")||document.activeElement.classList.contains("cke_dialog_ui_button")||i.CKEditor.save_data(o)},0)}),a.on("focus",function(){i.CKEditor._highlight_Textplugin(o)})},r.url=n,i.CKEditor.init(a[0],"inline",d,r)}}})},save_data:function(e,n){var o=i.CKEditor.editors[e];if(o.changed){var s=o.editor.getData();this.storeCSSlinks(),i.CKEditor.editors[e].changed=!1,i.API.Toolbar.showLoader(),t.post(i.API.Helpers.updateUrlWithPath(o.settings.url),{csrfmiddlewaretoken:i.config.csrf,body:s,_save:"Save"},function(s){if(i.API.Toolbar.hideLoader(),void 0!==n&&n(o,s),i.CKEditor.editors[e].child_changed){var r=t(s).find("script:not([src])").addClass("cms-ckeditor-result");i.CKEditor._destroyAll(),r.each(function(i,e){t("body").append(e)})}}).fail(function(t){i.CKEditor.editors[e].changed=!0,i.API.Messages.open(t)})}},storeCSSlinks:function(){t("link[rel='stylesheet'][type='text/css'][href*='ckeditor']").each(function(t,e){i.CKEditor.CSS.includes(e.href)||i.CKEditor.CSS.push(e.href)})},setupAdmin:function(){var i=this,n=window.parent||window;this._isAloneInModal()&&(i.editor.resize("100%",n.CMS.$(".cms-modal-frame").height()-70),this.editor.execCommand("maximize"),t(window).on("resize.ckeditor",function(){i._repositionDialog(e.dialog.getCurrent(),n)}).trigger("resize.ckeditor"),n.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(i.editor.resize("100%",n.CMS.$(".cms-modal-frame").height()-70),setTimeout(function(){i._repositionDialog(e.dialog.getCurrent(),n)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(e){e.preventDefault();var n=new i.$.Event("mousedown");t.extend(n,{screenX:e.originalEvent.screenX,screenY:e.originalEvent.screenY}),t(this).trigger(n)})},_isAloneInModal:function(){return this.container.closest("body").is(".app-djangocms_text_ckeditor.model-text")},_repositionDialog:function(t){if(t){var i=t.getSize(),n=t.getPosition(),o=e.document.getWindow(),s=o.getViewPaneSize(),r=s.width,d=s.height;n.x<0&&(t.move(0,n.y),n.x=0),n.y<0&&(t.move(n.x,0),n.y=0),n.y+i.height>d&&t.resize(i.width,d-n.y-80),n.x+i.width>r&&t.resize(r-n.x,i.height)}},initAdminEditors:function(){window._cmsCKEditors=window._cmsCKEditors||[];var e,n,o=[];window._cmsCKEditors.forEach(function(t){e=JSON.parse(document.getElementById("ck-text-config-"+t[1]).textContent),n=e.options,delete e.options,t[0].match(/__prefix__/)?o.push(t):i.CKEditor.init(document.getElementById(t[0]),"admin",n,e)}),t(".add-row a").on("click",function(){t(".CMS_CKEditor").each(function(s,r){var d=t(r);if(!d.data("ckeditor-initialized")){var a=d.attr("id");o.forEach(function(t){var o=t[0].id,s=new RegExp(o.replace("__prefix__","\\d+"));a.match(s)&&i.CKEditor.init(document.getElementById(a),n,e)})}})})},_highlight_Textplugin:function(e){var n=t(".cms-draggable-"+e),o=t(document),s=o.data("expandmode");o.data("expandmode",!1),n.parents(".cms-draggable").find('> .cms-dragitem-collapsable:not(".cms-dragitem-expanded") > .cms-dragitem-text').each(function(e,n){t(n).triggerHandler(i.Plugin.click)}),n.length>0&&(setTimeout(function(){o.data("expandmode",s)}),setTimeout(function(){var t=n.offsetParent(),e=n.position().top+t.scrollTop();n.offsetParent().scrollTop(e-window.innerHeight/2+50),i.Plugin._highlightPluginStructure(n.find(".cms-dragitem:first"),{successTimeout:200,delay:1500,seeThrough:!0})},10))},_initAll:function(){i.CKEditor.initInlineEditors(),i.CKEditor.initAdminEditors()},_destroyAll:function(){for(var t in i.CKEditor.editors)i.CKEditor.editors.hasOwnProperty(t)&&(i.CKEditor.editors[t].editor.destroy(),delete i.CKEditor.editors[t])},_resetInlineEditors:function(){i.CKEditor.CSS.forEach(function(i){0===t("link[href='"+i+"']").length&&t("head").append(t("<link rel='stylesheet' type='text/css' href='"+i+"'>"))}),i.CKEditor._destroyAll(),i.CKEditor._initAll()}},setTimeout(function(){i.CKEditor._initAll()},0),t(window).on("cms-content-refresh",i.CKEditor._resetInlineEditors)}(window.CMS.$,window.CMS,window.CKEDITOR);
/*
...
a.contextMenu&&a.contextMenu.addListener(function(a){if(a&&a.is("img")&&"iframe"==a.data("cke-real-element-type"))return{iframe:CKEDITOR.TRISTATE_OFF}})},afterInit:function(a){var b=a.dataProcessor;(b=b&&b.dataFilter)&&b.addRules({elements:{iframe:function(b){return a.createFakeParserElement(b,"cke_iframe","iframe",!0)}}})}})})();(function(){function v(a){function d(a){var b=!1;h.attachListener(h,"keydown",function(){var f=c.getBody().getElementsByTag(a);if(!b){for(var d=0;d<f.count();d++)f.getItem(d).setCustomData("retain",!0);b=!0}},null,null,1);h.attachListener(h,"keyup",function(){var d=c.getElementsByTag(a);b&&(1==d.count()&&!d.getItem(0).getCustomData("retain")&&CKEDITOR.tools.isEmpty(d.getItem(0).getAttributes())&&d.getItem(0).remove(1),b=!1)})}var b=this.editor;if(b&&!b.isDetached()){var c=a.document,e=c.body,f=c.getElementById("cke_actscrpt");
...
a.ui.addButton("JustifyBlock",{label:a.lang.common.justify,command:"justifyblock",toolbar:"align,40"}));a.on("dirChanged",l)}}})})();CKEDITOR.plugins.add("menubutton",{requires:"button,menu",onLoad:function(){var d=function(c){var a=this._,b=a.menu;a.state!==CKEDITOR.TRISTATE_DISABLED&&(a.on&&b?b.hide():(a.previousState=a.state,b||(b=a.menu=new CKEDITOR.menu(c,{panel:{className:"cke_menu_panel",attributes:{"aria-label":c.lang.common.options}}}),b.onHide=CKEDITOR.tools.bind(function(){var b=this.command?c.getCommand(this.command).modes:this.modes;this.setState(!b||b[c.mode]?a.previousState:CKEDITOR.TRISTATE_DISABLED);a.on=0},this),
...
!function(e){function t(e){var t=(e.match(/<\s*([^>\s]+)[\s\S]*?>/)||[0,!1]).splice(1),n=t.some(function(e){return e&&CKEDITOR.dtd.$block[e]}),i="span";return n&&(i="div"),i}function n(t,n){t.each(function(t,i){var l,s=e(i);l=e("<"+n+">"),e.each(i.attributes,function(e,t){l.attr(t.nodeName,t.nodeValue)}),l.html(s.html()),s.replaceWith(l)})}CKEDITOR&&CKEDITOR.plugins&&CKEDITOR.plugins.registered&&CKEDITOR.plugins.registered.cmsplugins||CKEDITOR.plugins.add("cmsplugins",{icons:"cmsplugins",init:function(t){var n=this;if(this.child_plugins=[],this.setupCancelCleanupCallback(t.config.settings),void 0===t.config.settings||void 0===t.config.settings.plugins)return!1;this.setupDialog(t),t.ui.add("cmsplugins",CKEDITOR.UI_PANELBUTTON,{toolbar:"cms,0",label:t.config.settings.lang.toolbar,title:t.config.settings.lang.toolbar,className:"cke_panelbutton__cmsplugins",modes:{wysiwyg:1},editorFocus:0,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(t.config.contentsCss),attributes:{role:"cmsplugins","aria-label":t.config.settings.lang.aria}},onBlock:function(i,l){console.log("onBlock",i,l,t),l.element.setHtml(t.plugins.cmsplugins.setupDropdown(t)),e(l.element.$).find(".cke_panel_listItem a").bind("click",function(l){l.preventDefault(),n.addPlugin(e(this),i,t)})}}),t.contextMenu&&this.setupContextMenu(t),t.addCommand("cmspluginsEdit",{exec:function(){var e=n.getElementFromSelection(t),i=n.getPluginWidget(e);console.log("cmspluginsEdit",e,i),i&&n.editPlugin(i,t)}});var i=function(n){var i;if("touchend"===n.type||"click"===n.type){var l=e(n.currentTarget).closest("cms-plugin")[0];console.log("plugin edit",l,l.parentElement),i=new CKEDITOR.dom.element(l).getParent(),n.data=n.data||{},t.getSelection().fake(i)}t.execCommand("cmspluginsEdit")};t.on("doubleclick",i),t.on("instanceReady",function(){}),this.setupDataProcessor(t)},getElementFromSelection:function(e){var t=e.getSelection();return t.getSelectedElement()||t.getCommonAncestor().getAscendant("cms-plugin",!0)},getPluginWidget:function(e){return e?e.getAscendant("cms-plugin",!0)||e.findOne("cms-plugin"):null},setupDialog:function(t){console.log("setupDialog",t);var n=this,i=function(){return{title:"",minWidth:200,minHeight:200,contents:[{elements:[{type:"html",html:'<iframe style="position:static; width:100%; height:100%; border:none;" />'}]}],onOk:function(i){var l=e(CKEDITOR.dialog.getCurrent().parts.contents.$).find("iframe").contents(),s=l[0].URL;l.find("form").submit();var a=CMS.API.Helpers.onPluginSave;return CMS.API.Helpers.onPluginSave=function(){CKEDITOR.dialog.getCurrent().hide();var e=CMS.API.Helpers.dataBridge,l=!1;return s.match(/add-plugin/)&&(l=!0),!t.config.settings.delete_on_cancel&&l&&n.child_plugins.push(e.plugin_id),console.log("about to insertPlugin",i),n.insertPlugin(e,i.sender._.editor),CMS.API.Helpers.onPluginSave=a,!1},!1}}};CKEDITOR.dialog.add("cmspluginsDialog",i)},setupDropdown:function(t){var n='<div class="cke_panel_block">';return e.each(t.config.settings.plugins,function(t,i){n+='<h1 class="cke_panel_grouptitle">'+i.group+"</h1>",n+='<ul role="presentation" class="cke_panel_list">',e.each(i.items,function(e,t){n+='<li class="cke_panel_listItem"><a href="#" rel="'+t.type+'">'+t.title+"</a></li>"}),n+="</ul>"}),n+="</div>"},setupContextMenu:function(e){var t=this;e.addMenuGroup("cmspluginsGroup"),e.addMenuItem("cmspluginsItem",{label:e.config.settings.lang.edit,icon:e.config.settings.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg",command:"cmspluginsEdit",group:"cmspluginsGroup"}),e.removeMenuItem("image"),e.contextMenu.addListener(function(e){if(t.getPluginWidget(e))return{cmspluginsItem:CKEDITOR.TRISTATE_OFF}})},editPlugin:function(t,n){var i=t.getAttribute("id");n.openDialog("cmspluginsDialog");var l=CMS.$(window),s=CKEDITOR.dialog.getCurrent();s.resize(.8*l.width(),.6*l.height()),e(s.getElement().$).addClass("cms-ckeditor-dialog"),e(s.parts.title.$).text(n.config.settings.lang.edit);var a=n.config.settings.url||window.location.href,o=encodeURIComponent(window.parent.location.pathname+window.parent.location.search),c=a.replace(/(add-plugin|edit-plugin).*$/,"edit-plugin/"+i+"/?_popup=1&no_preview&cms_history=0&cms_path="+o);CMS.CKEditor.editors[n.config.settings.plugin_id].changed=!0,CMS.CKEditor.editors[n.config.settings.plugin_id].child_changed=!0,e(s.parts.contents.$).find("iframe").attr("src",c).bind("load",function(){var t=e(this).contents();t.find("body").addClass("ckeditor-popup"),t.find(".submit-row").hide(),t.find("#container").css({"min-width":0,padding:0})})},addPlugin:function(e,t,n){t.hide(),n.focus(),n.fire("saveSnapshot");var i={placeholder_id:n.config.settings.placeholder_id,plugin_type:e.attr("rel"),plugin_parent:n.config.settings.plugin_id,plugin_language:n.config.settings.plugin_language,cms_path:window.parent.location.pathname,cms_history:0};console.log("Add for editior",n),this.addPluginDialog(e,i,n)},addPluginDialog:function(t,n,i){var l=e(window),s=i.getSelection().getSelectedText();i.openDialog("cmspluginsDialog");var a=CKEDITOR.dialog.getCurrent();a.resize(.8*l.width(),.6*l.height()),e(a.getElement().$).addClass("cms-ckeditor-dialog"),e(a.parts.title.$).text(i.config.settings.lang.add),e(a.parts.contents.$).find("iframe").attr("src",i.config.settings.add_plugin_url+"?"+e.param(n)).on("load.addplugin",function(){var t=e(this),n=t.contents();n.find(".submit-row").hide().end().find("#container").css("min-width",0).css("padding",0);var i=n.find(".js-ckeditor-use-selected-text");i.length||(i=n.find("#id_name")),i.val()&&i.val().trim()||i.val(s),t.off("load.addplugin")})},insertPlugin:function(t,n){e.ajax({method:"GET",url:n.config.settings.render_plugin_url,data:{token:n.config.settings.action_token,plugin:t.plugin_id}}).done(function(e){CMS.CKEditor.editors[n.config.settings.plugin_id].changed=!0,CMS.CKEditor.editors[n.config.settings.plugin_id].child_changed=!0,console.log("instert into Editor",n),n.insertHtml(e,"unfiltered_html"),n.fire("updateSnapshot")})},setupCancelCleanupCallback:function(t){if(window.parent&&window.parent.CMS&&window.parent.CMS.API&&window.parent.CMS.API.Helpers){var n=this,i=window.parent.CMS,l=function(l,s){if((t.delete_on_cancel||n.child_plugins.length)&&n.child_plugins.length){l.preventDefault(),i.API.Toolbar.showLoader();var a={token:t.action_token};t.delete_on_cancel||(a.child_plugins=n.child_plugins),e.ajax({method:"POST",url:t.cancel_plugin_url,data:a,traditional:!0}).done(function(){i.API.Helpers.removeEventListener("modal-close.text-plugin.text-plugin-"+t.plugin_id),s.instance.close()}).fail(function(e){i.API.Messages.open({message:e.responseText+" | "+e.status+" "+e.statusText,delay:0,error:!0})})}};i.API.Helpers.addEventListener("modal-close.text-plugin.text-plugin-"+t.plugin_id,l)}},setupDataProcessor:function(i){function l(e){return e.attributes&&"div"===e.attributes["data-cke-real-element-type"]}CKEDITOR.htmlParser.element=CKEDITOR.tools.override(CKEDITOR.htmlParser.element,function(e){return function(t,n){e.call(this,t,n),"cms-plugin"===t&&"span"===n["data-cke-real-element-type"]&&(this._.isBlockLike=!1)}}),i.dataProcessor.dataFilter.addRules({elements:{span:function(t){if(CKEDITOR.plugins.widget.isParserWidgetWrapper(t)){var n=t.getFirst();if(l(n)){var s=new CKEDITOR.htmlParser.element("div",e.extend({},t.attributes));return i.widgets.registered.cmswidget.inline=!1,s.children=t.children,s.removeClass("cke_widget_inline"),s.removeClass("cke_widget_force_block"),s.addClass("cke_widget_block"),n.attributes["data-cke-real-element-type"]="div",s}i.widgets.registered.cmswidget.inline=!0,n.attributes["data-cke-real-element-type"]="span"}return t}}},{priority:1,applyToAll:!0}),i.on("toHtml",function(i){var l=i.data.dataValue.replace(/<cms-plugin(.*?)>([\s\S]*?)<\/cms-plugin>/gi,function(e,n,i){var l=t(i);return n.match(/render-plugin=["']?false/gi)?'<cms-plugin data-cke-real-element-type="'+l+'" '+n+"><"+l+' class="cms-ckeditor-plugin-label">'+n.replace(/[\s\S]*alt=["']([\s\S]*?)['"][\s\S]*/,"$1")+"</"+l+"></cms-plugin>":'<cms-plugin data-cke-real-element-type="'+l+'" '+n+">"+i+"</cms-plugin>"});if(l.match(/<cms-plugin[^>]*(?=data-cke-real-element-type=\"div)/)){var s=/<cms-plugin([^>]*(?=data-cke-real-element-type=\"div)[\s\S]*?>[\s\S]*?<\/)cms-plugin>/g,a=l.replace(s,"<div$1div>"),o=e(a).wrapAll("<div>").parent();n(o.find('div[data-cke-real-element-type="div"]'),"cms-plugin"),l=o.html()}i.data.dataValue=l},null,null,4),i.on("toHtml",function(){i.widgets&&i.widgets.registered&&i.widgets.registered.cmswidget&&(i.widgets.registered.cmswidget.inline=!0)},null,null,1)}})}(CMS.$);
});
})(CMS.$);
