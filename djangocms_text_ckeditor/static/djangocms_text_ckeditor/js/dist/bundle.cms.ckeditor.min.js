 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
CKEDITOR.plugins.add("cmsresize",{init:function(e){function i(i){var t=i.originalEvent.screenX-s.x,r=i.originalEvent.screenY-s.y,d=a.width,c=a.height,z=d+t*("rtl"==o?-1:1),l=c+r;m&&(d=Math.max(n.resize_minWidth,Math.min(z,n.resize_maxWidth))),h&&(c=Math.max(n.resize_minHeight,Math.min(l,n.resize_maxHeight))),e.resize(m?d:null,c)}function t(){CMS.$(CKEDITOR.document.$).off("pointermove",i),CMS.$(CKEDITOR.document.$).off("pointerup",t),e.document&&(CMS.$(e.document.$).off("pointermove",i),CMS.$(e.document.$).off("pointerup",t))}var n=e.config,r=e.ui.spaceId("resizer"),o=e.element?e.element.getDirection(1):"ltr";if(!n.resize_dir&&(n.resize_dir="vertical"),void 0===n.resize_maxWidth&&(n.resize_maxWidth=3e3),void 0===n.resize_maxHeight&&(n.resize_maxHeight=3e3),void 0===n.resize_minWidth&&(n.resize_minWidth=750),void 0===n.resize_minHeight&&(n.resize_minHeight=250),n.resize_enabled!==!1){var s,a,d=null,m=("both"==n.resize_dir||"horizontal"==n.resize_dir)&&n.resize_minWidth!=n.resize_maxWidth,h=("both"==n.resize_dir||"vertical"==n.resize_dir)&&n.resize_minHeight!=n.resize_maxHeight,c=CKEDITOR.tools.addFunction(function(r){d||(d=e.getResizable()),a={width:d.$.offsetWidth||0,height:d.$.offsetHeight||0},s={x:r.screenX,y:r.screenY},n.resize_minWidth>a.width&&(n.resize_minWidth=a.width),n.resize_minHeight>a.height&&(n.resize_minHeight=a.height),CMS.$(CKEDITOR.document.$).on("pointermove",i),CMS.$(CKEDITOR.document.$).on("pointerup",t),e.document&&(CMS.$(e.document.$).on("pointermove",i),CMS.$(e.document.$).on("pointerup",t)),r.preventDefault&&r.preventDefault()});CMS.$(CKEDITOR.document.$).find("html").attr("data-touch-action","none"),e.on("destroy",function(){CKEDITOR.tools.removeFunction(c)}),e.on("uiSpace",function(i){if("bottom"==i.data.space){var t="";m&&!h&&(t=" cke_resizer_horizontal"),!m&&h&&(t=" cke_resizer_vertical");var n='<span id="'+r+'" class="cms-ckeditor-resizer cke_resizer'+t+" cke_resizer_"+o+'" title="'+CKEDITOR.tools.htmlEncode(e.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+c+', event)">'+("ltr"==o?"◢":"◣")+"</span>";"ltr"==o&&"ltr"==t?i.data.html+=n:i.data.html=n+i.data.html}},e,null,100),e.on("maximize",function(i){e.ui.space("resizer")[i.data==CKEDITOR.TRISTATE_ON?"hide":"show"]()})}}});
!function(e){function t(e){var t=(e.match(/<([\S]*?)\s[\s\S]*?>/)||[0,!1]).splice(1),i=t.some(function(e){return e&&CKEDITOR.dtd.$block[e]}),n="span";return i&&(n="div"),n}function i(t,i){t.each(function(t,n){var s,o=e(n);s=e("<"+i+">"),e.each(n.attributes,function(e,t){s.attr(t.nodeName,t.nodeValue)}),s.html(o.html()),o.replaceWith(s)})}CKEDITOR.plugins.add("cmsplugins",{icons:"cmsplugins",init:function(t){var i=this;if(this.options=CMS.CKEditor.options.settings,this.editor=t,this.child_plugins=[],this.setupCancelCleanupCallback(this.options),void 0===this.options||void 0===this.options.plugins)return!1;this.setupDialog(),this.editor.ui.add("cmsplugins",CKEDITOR.UI_PANELBUTTON,{toolbar:"cms,0",label:this.options.lang.toolbar,title:this.options.lang.toolbar,className:"cke_panelbutton__cmsplugins",modes:{wysiwyg:1},editorFocus:0,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(i.editor.config.contentsCss),attributes:{role:"cmsplugins","aria-label":this.options.lang.aria}},onBlock:function(t,n){n.element.setHtml(i.editor.plugins.cmsplugins.setupDropdown());var s=e(n.element.$).find(".cke_panel_listItem a");s.bind("click",function(n){n.preventDefault(),i.addPlugin(e(this),t)})}}),this.editor.contextMenu&&this.setupContextMenu(),this.editor.addCommand("cmspluginsEdit",{exec:function(){var e=i.getElementFromSelection(),t=i.getPluginWidget(e);t&&i.editPlugin(t)}});var n=function(t){var n;if("touchend"===t.type||"click"===t.type){var s=e(t.currentTarget).closest("cms-plugin")[0];n=new CKEDITOR.dom.element(s).getParent(),t.data=t.data||{},i.editor.getSelection().fake(n)}i.editor.execCommand("cmspluginsEdit")};this.editor.on("doubleclick",n),this.editor.on("instanceReady",function(){CMS.$("cms-plugin",CMS.$("iframe.cke_wysiwyg_frame")[0].contentWindow.document.documentElement).on("click touchend",n)}),this.setupDataProcessor()},getElementFromSelection:function(){var e=this.editor.getSelection(),t=e.getSelectedElement()||e.getCommonAncestor().getAscendant("cms-plugin",!0);return t},getPluginWidget:function(e){return e?e.getAscendant("cms-plugin",!0)||e.findOne("cms-plugin"):null},setupDialog:function(){var t=this,i=function(){return{title:"",minWidth:600,minHeight:300,contents:[{elements:[{type:"html",html:'<iframe style="position:static; width:100%; height:100%; border:none;" />'}]}],onOk:function(){var i=e(CKEDITOR.dialog.getCurrent().parts.contents.$).find("iframe").contents();i.find("form").submit();var n=CMS.API.Helpers.reloadBrowser;return CMS.API.Helpers.reloadBrowser=function(){return CKEDITOR.dialog.getCurrent().hide(),t.insertPlugin(CMS.API.Helpers.dataBridge),CMS.API.Helpers.reloadBrowser=n,!1},!1}}};CKEDITOR.dialog.add("cmspluginsDialog",i)},setupDropdown:function(){var t='<div class="cke_panel_block">';return e.each(this.options.plugins,function(i,n){t+='<h1 class="cke_panel_grouptitle">'+n.group+"</h1>",t+='<ul role="presentation" class="cke_panel_list">',e.each(n.items,function(e,i){t+='<li class="cke_panel_listItem"><a href="#" rel="'+i.type+'">'+i.title+"</a></li>"}),t+="</ul>"}),t+="</div>"},setupContextMenu:function(){var e=this;this.editor.addMenuGroup("cmspluginsGroup"),this.editor.addMenuItem("cmspluginsItem",{label:this.options.lang.edit,icon:this.path+"icons/cmsplugins.png",command:"cmspluginsEdit",group:"cmspluginsGroup"}),this.editor.removeMenuItem("image"),this.editor.contextMenu.addListener(function(t){var i=e.getPluginWidget(t);if(i)return{cmspluginsItem:CKEDITOR.TRISTATE_OFF}})},editPlugin:function(t){var i=t.getAttribute("id");this.editor.openDialog("cmspluginsDialog");var n=CMS.$(document),s=CKEDITOR.dialog.getCurrent();s.resize(.8*n.width(),.7*n.height()),e(s.getElement().$).addClass("cms-ckeditor-dialog"),e(s.parts.title.$).text(this.options.lang.edit),e(s.parts.contents.$).find("iframe").attr("src","../"+i+"/?_popup=1&no_preview").bind("load",function(){var t=e(this).contents();t.find("body").addClass("ckeditor-popup"),t.find(".submit-row").hide(),t.find("#container").css({"min-width":0,padding:0})})},addPlugin:function(e,t){var i=this;t.hide(),this.editor.focus(),this.editor.fire("saveSnapshot");var n={placeholder_id:this.options.placeholder_id,plugin_type:e.attr("rel"),plugin_parent:this.options.plugin_id,plugin_language:this.options.plugin_language};i.addPluginDialog(e,n)},addPluginDialog:function(t,i){var n=e(document),s=this.editor.getSelection().getSelectedText();this.editor.openDialog("cmspluginsDialog");var o=CKEDITOR.dialog.getCurrent();o.resize(.8*n.width(),.7*n.height()),e(o.getElement().$).addClass("cms-ckeditor-dialog"),e(o.parts.title.$).text(this.options.lang.add),e(o.parts.contents.$).find("iframe").attr("src",this.options.add_plugin_url+"?"+e.param(i)).bind("load",function(){var t=e(this).contents();t.find(".submit-row").hide().end().find("#container").css("min-width",0).css("padding",0);var i=t.find(".js-ckeditor-use-selected-text");i.length||(i=t.find("#id_name")),i.val(s)})},insertPlugin:function(t){var i=this;e.ajax({method:"GET",url:i.options.render_plugin_url,data:{token:i.options.action_token,plugin:t.plugin_id}}).done(function(e){i.options.delete_on_cancel||i.child_plugins.push(t.plugin_id),i.editor.insertHtml(e,"unfiltered_html"),i.editor.fire("updateSnapshot")})},setupCancelCleanupCallback:function(){if(window.parent&&window.parent.CMS&&window.parent.CMS.API&&window.parent.CMS.API.Helpers){var t=this,i=window.parent.CMS,n=function(n,s){if(t.options.delete_on_cancel||t.child_plugins.length){n.preventDefault(),i.API.Toolbar.showLoader();var o={token:t.options.action_token};t.options.delete_on_cancel||(o.child_plugins=t.child_plugins),e.ajax({method:"POST",url:t.options.cancel_plugin_url,data:o,traditional:!0}).done(function(){i.API.Helpers.removeEventListener("modal-close.text-plugin-"+t.options.plugin_id),s.instance.close()}).fail(function(e){i.API.Messages.open({message:e.responseText+" | "+e.status+" "+e.statusText,delay:0,error:!0})})}};i.API.Helpers.addEventListener("modal-close.text-plugin-"+t.options.plugin_id,n)}},setupDataProcessor:function(){function n(e){return e.attributes&&"div"===e.attributes["data-cke-real-element-type"]}var s=this,o=1,l=4;this.editor.dataProcessor.dataFilter.addRules({elements:{span:function(t){if(CKEDITOR.plugins.widget.isParserWidgetWrapper(t)){var i=t.getFirst();if(n(i)){var o=new CKEDITOR.htmlParser.element("div",e.extend({},t.attributes));return s.editor.widgets.registered.cmswidget.inline=!1,o.children=t.children,o.removeClass("cke_widget_inline"),o.removeClass("cke_widget_force_block"),o.addClass("cke_widget_block"),i.attributes["data-cke-real-element-type"]="div",o}s.editor.widgets.registered.cmswidget.inline=!0,i.attributes["data-cke-real-element-type"]="span"}return t}}},{priority:1,applyToAll:!0}),this.editor.on("toHtml",function(n){var s=n.data.dataValue.replace(/<cms-plugin(.*?)>([\s\S]*?)<\/cms-plugin>/gi,function(e,i,n){var s=t(n);return i.match(/render-plugin=["']?false/gi)?'<cms-plugin data-cke-real-element-type="'+s+'" '+i+"><"+s+' class="cms-ckeditor-plugin-label">'+i.replace(/[\s\S]*alt=["']([\s\S]*?)['"][\s\S]*/,"$1")+"</"+s+"></cms-plugin>":'<cms-plugin data-cke-real-element-type="'+s+'" '+i+">"+n+"</cms-plugin>"});if(s.match(/<cms-plugin[^>]*(?=data-cke-real-element-type=\"div)/)){var o=/<cms-plugin([^>]*(?=data-cke-real-element-type=\"div).*?>.*?<\/)cms-plugin>/g,l=s.replace(o,"<div$1div>"),a=e(l).wrapAll("<div>").parent(),r=a.find('div[data-cke-real-element-type="div"]');i(r,"cms-plugin"),s=a.html()}n.data.dataValue=s},null,null,l),this.editor.on("toHtml",function(){s.editor.widgets&&s.editor.widgets.registered&&s.editor.widgets.registered.cmswidget&&(s.editor.widgets.registered.cmswidget.inline=!0)},null,null,o)}})}(CMS.$);
!function(t){t(function(){CMS.CKEditor={options:{language:"en",skin:"moono",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Maximize",""],"/",["Bold","Italic","Underline","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList","-","Outdent","Indent","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Maximize",""],"/",["Bold","Italic","Underline","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList","-","Outdent","Indent","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},init:function(e,i,n){t("#"+e).length>0&&(this.container=t("#"+e),this.options.toolbar=n.toolbar,this.options=t.extend(!1,{settings:n},this.options,i),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsresize,cmsdialog,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",n.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.png"),this.editor=CKEDITOR.replace(e,this.options),CKEDITOR.on("instanceReady",t.proxy(CMS.CKEditor,"setup")))},setup:function(){var t=this,e=window.parent||window,i=70;this._isAloneInModal()&&(t.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-i),this.editor.execCommand("maximize"),e.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t.editor.resize("100%",e.CMS.$(".cms-modal-frame").height()-i)}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(e){e.preventDefault();var i=new CMS.$.Event("mousedown");t.extend(i,{screenX:e.originalEvent.screenX,screenY:e.originalEvent.screenY}),t(this).trigger(i)})},_isAloneInModal:function(){var t=this.container.closest("body");return t.is(".app-djangocms_text_ckeditor.model-text")||t.is(".djangocms_text_ckeditor-text")}}})}(CMS.$);