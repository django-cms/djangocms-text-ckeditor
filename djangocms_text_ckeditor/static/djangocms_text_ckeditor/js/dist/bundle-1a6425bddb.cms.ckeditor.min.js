...
!function(t,e){"use strict";window.CKEDITOR_BASEPATH=t("[data-ckeditor-basepath]").attr("data-ckeditor-basepath"),e.CKEditor={options:{language:"en",skin:"moono-lisa",toolbar_CMS:[["Undo","Redo"],["cmsplugins","cmswidget","-","ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockquote","-","Link","Unlink","-","Table"],["Source"]],toolbar_HTMLField:[["Undo","Redo"],["ShowBlocks"],["Format","Styles"],["TextColor","BGColor","-","PasteText","PasteFromWord"],["Scayt"],["Maximize",""],"/",["Bold","Italic","Underline","Strike","-","Subscript","Superscript","-","RemoveFormat"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["HorizontalRule"],["Link","Unlink"],["NumberedList","BulletedList"],["Outdent","Indent","-","Blockqote","-","Link","Unlink","-","Table"],["Source"]],allowedContent:!0,toolbarCanCollapse:!1,removePlugins:"resize",extraPlugins:""},static_url:"/static/djangocms-text-ckeditor",ckeditor_basepath:"/static/djangocms-text-ckeditor/ckeditor/",CSS:[],editors:{},init:function(i,o,n,r){this.container=t(i),this.container.data("ckeditor-initialized",!0),this.options.toolbar=r.toolbar,this.options=t.extend(!1,{settings:r},this.options,n),this.options.extraPlugins=this.options.extraPlugins+=",cmsplugins,cmswidget,cmsdialog,cmsresize,widget",document.createElement("cms-plugin"),CKEDITOR.dtd["cms-plugin"]=CKEDITOR.dtd.div,CKEDITOR.dtd.$inline["cms-plugin"]=1,CKEDITOR.dtd.$nonEditable["cms-plugin"]=1,CKEDITOR.dtd.$transparent["cms-plugin"]=1,CKEDITOR.dtd.body["cms-plugin"]=1,CKEDITOR.skin.addIcon("cmsplugins",r.static_url+"/ckeditor_plugins/cmsplugins/icons/cmsplugins.svg"),"admin"===o?(this.editor=CKEDITOR.replace(i,this.options),CKEDITOR.on("instanceReady",t.proxy(e.CKEditor,"setupAdmin"))):(this.editor=CKEDITOR.inline(i,this.options),CKEDITOR.on("instanceReady",r.callback)),e.CKEditor.editors[this.editor.id]={editor:this.editor,options:n,settings:r,container:i,changed:!1,child_changed:!1}},initInlineEditors:function(){void 0!==e._plugins&&(e.CKEditor.observer=e.CKEditor.observer||new IntersectionObserver(function(t,i){t.forEach(function(t){if(t.isIntersecting){var i=t.target.dataset.plugin_id,o=t.target.dataset.edit_url;void 0===e.CKEditor.editors[i]&&e.CKEditor.startInlineEditor(i,o)}})},{root:null,threshold:.5}),e._plugins.forEach(function(i){if("TextPlugin"===i[1].plugin_type){var o=i[1].urls.edit_plugin,n=i[1].plugin_id,r=t(".cms-plugin.cms-plugin-"+n);if(r.length>0){console.log("Observe",n);var s=r.wrapAll("<div class='cms-ckeditor-inline-wrapper' contenteditable='true'></div>").parent();r.removeClass("cms-plugin").removeClass("cms-plugin-"+n),s.addClass("cms-plugin").addClass("cms-plugin-"+n),s.attr("data-edit_url",o),s.attr("data-plugin_id",n),s.on("clickx",function(t){t.stopPropagation()}),s.on("dblclick",function(t){t.stopPropagation()}),s.on("pointerover",function(t){t.stopPropagation()}),e.CKEditor.observer.observe(s[0])}}}))},startInlineEditor:function(i,o){console.log("startInlineEditor",i,o);var n={},r=JSON.parse(document.getElementById("ck-cfg-"+i).textContent),s=t(".cms-plugin.cms-plugin-"+i);if(s[0].dataset.editor)return void console.log("Already contains editor");console.log(s),r&&(n=r.options,delete r.options),r.plugin_id=i,r.callback=function(t){var o=t.editor;o.element.removeAttribute("title"),console.log(o.element,o.element.dataset),o.element.$.dataset.editor=!0,console.log("Element",o.element),o.on("change",function(){e.CKEditor.editors[o.id].changed=!0}),s.on("blur",function(){setTimeout(function(){document.activeElement.classList.contains("cke_panel_frame")||document.activeElement.classList.contains("cke_dialog_ui_button")||e.CKEditor.save_data(o.id)},0)}),s.on("click",function(){e.CKEditor._highlight_Textplugin(i)}),e.CKEditor.storeCSSlinks()},r.url=o,e.CKEditor.init(s[0],"inline",n,r)},save_data:function(i,o){var n=e.CKEditor.editors[i];if(n&&n.changed){e.CKEditor.storeCSSlinks();var r=n.editor.getData();n.changed=!1,e.API.Toolbar.showLoader(),t.post(e.API.Helpers.updateUrlWithPath(n.settings.url),{csrfmiddlewaretoken:e.config.csrf,body:r,_save:"Save"},function(i){if(e.API.Toolbar.hideLoader(),void 0!==o&&o(n,i),n.child_changed){var r=t(i).find("script:not([src])").addClass("cms-ckeditor-result");e.CKEditor._destroyAll(),r.each(function(e,i){t("body").append(i)})}else e.CKEditor.loadToolbar()}).fail(function(t){n.changed=!0,e.API.Messages.open({message:t.message,error:!0})})}},loadToolbar:function(){e.API.StructureBoard._loadToolbar().done(function(i){e.API.Toolbar._refreshMarkup(t(i).find(".cms-toolbar"))}).fail(e.API.Helpers.reloadBrowser)},storeCSSlinks:function(){t("link[rel='stylesheet'][type='text/css'][href*='ckeditor']").each(function(t,i){e.CKEditor.CSS.includes(i.href)||e.CKEditor.CSS.push(i.href)})},setupAdmin:function(){var e=this,i=window.parent||window;this._isAloneInModal()&&(e.editor.resize("100%",i.CMS.$(".cms-modal-frame").height()-70),this.editor.execCommand("maximize"),t(window).on("resize.ckeditor",function(){e._repositionDialog(CKEDITOR.dialog.getCurrent(),i)}).trigger("resize.ckeditor"),i.CMS.API.Helpers.addEventListener("modal-maximized modal-restored",function(){try{t(".cke_maximized").length||(e.editor.resize("100%",i.CMS.$(".cms-modal-frame").height()-70),setTimeout(function(){e._repositionDialog(CKEDITOR.dialog.getCurrent(),i)},0))}catch(t){}})),this.styles(),this._resizing()},styles:function(){t(".cke_button__maximize, .cke_button__source").parent().css("margin-right",0).parent().css("float","right")},_resizing:function(){t(document).on("pointerdown",".cms-ckeditor-resizer",function(i){i.preventDefault();var o=new e.$.Event("mousedown");t.extend(o,{screenX:i.originalEvent.screenX,screenY:i.originalEvent.screenY}),t(this).trigger(o)})},_isAloneInModal:function(){return this.container.closest("body").is(".app-djangocms_text_ckeditor.model-text")},_repositionDialog:function(t){if(t){var e=t.getSize(),i=t.getPosition(),o=CKEDITOR.document.getWindow(),n=o.getViewPaneSize(),r=n.width,s=n.height;i.x<0&&(t.move(0,i.y),i.x=0),i.y<0&&(t.move(i.x,0),i.y=0),i.y+e.height>s&&t.resize(e.width,s-i.y-80),i.x+e.width>r&&t.resize(r-i.x,e.height)}},initAdminEditors:function(){window._cmsCKEditors=window._cmsCKEditors||[];var i,o,n=[];window._cmsCKEditors.forEach(function(t){var r="ck-cfg-"+(t[1]?t[1]:t[0]);i=JSON.parse(document.getElementById(r).textContent),o=i.options,delete i.options,t[0].match(/__prefix__/)?n.push(t):e.CKEditor.init(document.getElementById(t[0]),"admin",o,i)}),t(".add-row a").on("click",function(){t(".CMS_CKEditor").each(function(r,s){var d=t(s);if(!d.data("ckeditor-initialized")){var a=d.attr("id");n.forEach(function(t){var n=t[0].id,r=new RegExp(n.replace("__prefix__","\\d+"));a.match(r)&&e.CKEditor.init(document.getElementById(a),o,i)})}})})},_highlight_Textplugin:function(i){var o=t(".cms-draggable-"+i),n=t(document),r=n.data("expandmode");n.data("expandmode",!1),o.parents(".cms-draggable").find('> .cms-dragitem-collapsable:not(".cms-dragitem-expanded") > .cms-dragitem-text').each(function(i,o){t(o).triggerHandler(e.Plugin.click)}),o.length>0&&(setTimeout(function(){n.data("expandmode",r)}),setTimeout(function(){var t=o.offsetParent(),i=o.position().top+t.scrollTop();o.offsetParent().scrollTop(i-window.innerHeight/2+50),e.Plugin._highlightPluginStructure(o.find(".cms-dragitem:first"),{successTimeout:200,delay:2e3,seeThrough:!0})},10))},_initAll:function(){e.CKEditor.touchdevice="ontouchstart"in window||navigator.msMaxTouchPoints,e.CKEditor.touchdevice||e.CKEditor.initInlineEditors(),e.CKEditor.initAdminEditors()},_destroyAll:function(){for(var t in e.CKEditor.editors)e.CKEditor.editors.hasOwnProperty(t)&&(e.CKEditor.editors[t].editor.destroy(),delete e.CKEditor.editors[t])},_resetInlineEditors:function(){e.CKEditor.CSS.forEach(function(e){0===t("link[href='"+e+"']").length&&t("head").append(t("<link rel='stylesheet' type='text/css' href='"+e+"'>"))}),e.CKEditor._destroyAll(),e.CKEditor._initAll()}},setTimeout(function(){e.CKEditor._initAll()},0),t(window).on("cms-content-refresh",e.CKEditor._resetInlineEditors),window._scrl=window.scrollTo,window.scrollTo=function(t){console.log("ScrollTo",t),window._scrl(t)}}(window.CMS.$,window.CMS);
/*
